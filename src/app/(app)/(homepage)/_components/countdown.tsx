...
function CountdownCard({ name, children }: { children: ReactNode; name: string }) {
  return (
    <div className="flex flex-col items-center gap-3">
      <Card className="flex px-5 py-3 flex-col justify-center items-center text-2xl font-bold h-14 w-14 lg:h-[4.7rem] lg:w-[4.7rem]">
        {children}
      </Card>
...
export function Countdown() {
  ...
  return (
    <div className="flex gap-8">
      <CountdownCard name="Dni">{days}</CountdownCard>
